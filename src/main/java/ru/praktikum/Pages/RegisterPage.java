...
public class RegisterPage {
    ...
    public static void completionUserData(WebDriver driver, RandomUserData randomUserData) {

        driver.findElement(fieldRegisterName).sendKeys(RandomUserData.getName());
